...
validated_table_name('masterschoollist',cursor)

measure_column_name = "test col name"
sql_string = "INSERT INTO " + validated_table_name("masterschoollist",cursor) + " (" + measure_column_name + ") " + "VALUES (%s);"
#WHERE school_name =%s
